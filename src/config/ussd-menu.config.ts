...
export const ussdMenus: Record<string, UssdMenuScreen> = {
  ...
  customerName: {
    text: `CON Foaman Onboarding\nEnter your Full Name:`,
    type: 'input',
    property: 'fullName',
    next: 'customerLocation',
  },
  customerLocation: {
    text: `CON Enter your Location:\n(e.g., Roysambu, Kasarani)`,
    type: 'input',
    property: 'location',
    next: 'customerComplete',
  },
  customerComplete: {
    text: `CON Profile saved successfully!\n1. Advertise a Job\n2. Main Menu`,
    type: 'choice',
  ...
  // --- MONETIZATION & UTILS ---
  premiumCheck: {
    text: `CON This contact costs 10 KSh Airtime.\n1. Proceed\n0. Back`,
    type: 'choice',
    options: { 1: "premiumSuccess", 0: "main" },
  },
  premiumSuccess: {
    text: `END Contact: 0720459045\nName: Francis M.\nDetails also sent via SMS.`,
    type: 'final',
  },
  myRequests: {
    text: `CON My Requests\n1. Active Jobs\n2. Completed\n0. Back`,
    type: 'choice',
